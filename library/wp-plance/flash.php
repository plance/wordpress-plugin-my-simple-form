...
class Plance_Flash
{
	...
	{
		$c = '<div id="message" class="'.$class.' notice is-dismissible plance-'.$class.'-block">';
		if(is_admin())
		{
		...
		{
			foreach($message as $i => $text)
			{
				$c .= '<p id="plance-error-'.$i.'"><strong>'.$text.'</strong></p>';
			}
		}
		else
		{
